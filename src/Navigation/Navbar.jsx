...
import { NavbarColorContext, NavbarContext } from "../Component/Context/Context";
...
export default function Navbar() {
    ...
    return (
        <div className="flex w-screen justify-between top-0 left-0 fixed z-10
        lg:h-15 h-10">
            <Link to="/" className="lg:border-white lg:border-2 p-2 mt-2
            b-top-none lg:w-40  w-20 h-13 lg:h-18 flex items-start justify-center  pt-2 left-0 top-0">
                <svg xmlns="http://www.w3.org/2000/svg" fill={NavColor} width="180" height="50" viewBox="0 0 103 44">
  ...
  className="group lg:h-15 h-10 lg:w-60 w-50 bg-black flex relative flex-col items-end ml-auto"
>
  <div
    ref={navGreenRef}
    className="transition-all w-full bg-[#D3FD50] h-0 relative top-0"
  />

  <div className="flex flex-col items-end gap-1.75 mr-12 absolute 
  z-10 left-auto top-5">
    <div className="w-18 h-0.5 bg-white group-hover:bg-black"></div>
    <div className="w-10 h-0.5 bg-white group-hover:bg-black"></div>
  </div>
</div>
        </div>
    );
